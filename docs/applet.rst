...
Erdős–Rényi graph of 500 oscillators, laid out once by a spring embedding and
then frozen, being integrated as you watch.
...
the information in it, which is the Maxwell's-demon reading of the paper.
...
:math:`r(t)` traces: the continuum limit reproduces the suppression without
ever containing an agent.
